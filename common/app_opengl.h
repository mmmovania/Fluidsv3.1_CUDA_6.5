...
int InitWindow ( HINSTANCE hInstance, int show )
{
    ...
    g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", "Fluids v.3.1 (c) Zlib, Rama Hoetzlein 2013", WS_OVERLAPPEDWINDOW, 0, 0, window_width, window_height, NULL, NULL, hInstance, NULL );
    if( g_hWnd == NULL )
        return E_FAIL;
